...
def compareAPI(exampleAPI, outputAPI):
	...
	if boolean: 
		...
		print json.dumps(structDiff,indent=4, separators=(',', ': '))
		return False
...
#main
	...
	for key in templateDic:
		...
		if not outputDic.has_key(key):
			outputDic[key] = "<error: it should have key: {}>".format(str(key))
...
compareAPI(exampleSongInfo,outputToBeTested)